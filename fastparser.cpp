...
const Ob::Ptr FastParser::abytesp(new Symbol);
const Ob::Ptr FastParser::abyteslen(new Symbol);
const Ob::Ptr FastParser::abytescat(new Symbol);
const Ob::Ptr FastParser::abytesmid(new Symbol);
const Ob::Ptr FastParser::aserint(new Symbol);
const Ob::Ptr FastParser::aserfloat(new Symbol);
const Ob::Ptr FastParser::aserbyte(new Symbol);
const Ob::Ptr FastParser::aser2bytes(new Symbol);
const Ob::Ptr FastParser::aser4bytes(new Symbol);
const Ob::Ptr FastParser::aser8bytes(new Symbol);
const Ob::Ptr FastParser::agetint(new Symbol);
const Ob::Ptr FastParser::agetfloat(new Symbol);
const Ob::Ptr FastParser::agetbyte(new Symbol);
